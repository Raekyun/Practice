import pandas as pd
from MG_optimal_sizing.utils import plot_Series, plot_DataFrame
from MG_optimal_sizing.read_data import read_load, read_pv_PVWatts
...
def resiliency_sizing(pv_range, reserved_day, starting_day = 0,
    ...
    for cap in pv_range:
        ...
        fuel_weekly['pv_curtailment_converted_to_fuel'] = merged_weekly.pv_curtailment / 13    ## PV curtailment 만큼 ESS 저장한다는 가정
